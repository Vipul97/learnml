...
3.  The pull request should work for Python 3.6, 3.7 and 3.8. Check <https://travis-ci.org/github/Vipul97/learnml/pull_requests> and make sure that the tests pass for all supported Python versions.
